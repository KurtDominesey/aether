...
if __name__ == '__main__':
    ...
    ax0.set_yticks([])
    ax0.text(
        0.35, 0.68, "UO2", ha="center", va="center", rotation=90, size=15,
    ...
    ax0.set_ylabel('k-Eigenvalue', labelpad=42.5)
    plt.savefig('plot_compare_k-2.pdf')